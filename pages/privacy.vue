            ...
            <div class="content has-text-left">
              <nav class="breadcrumb mb-2" aria-label="breadcrumbs">
                <ul class="ml-0 d-flex">
                  ...
                  <li class="is-active">
                    <a aria-current="page">Privacy Policy</a>
                  </li>
                </ul>
              </nav>
              <h1 class="is-size-4 has-text-black has-text-weight-bold mb-5 mt-0">Privacy policy</h1>
              <div>
                This privacy policy applies between you, the User of this Website and Family Tree 365 Ltd, the owner and
                provider of this Website. Family Tree 365 Ltd takes the privacy of your information very seriously. This
                privacy policy applies to our use of any and all Data collected by us or provided by you in relation to
              ...
              <div>
                ...
                <a href="/termsandconditions" target="_blank" class="has-text-link"
                  >www.familytree365.com/termsandconditions.</a
                >
              </div>
              <div class="is-size-6 has-text-black has-text-weight-medium my-5">
                Please read this privacy policy carefully.
              </div>
              <div class="is-size-6 has-text-black has-text-weight-medium my-5">Definitions and interpretation</div>
              ...
              <div class="mb-3">
                Cookies a small text file placed on your computer by this Website when you visit certain parts of the
              ...
              <div class="mb-3">
                ...
                limited to the Directive 96/46/EC (Data Protection Directive) or the GDPR, and any national implementing
                laws, regulations and secondary legislation, for as long as the GDPR is effective in the UK;
              </div>
              <div class="mb-3">GDPR the General Data Protection Regulation (EU) 2016/679;</div>
              <div class="mb-3">
                Family Tree 365 Ltd, we or us Family Tree 365 Ltd, a company incorporated in England and Wales with
                registered number 12734769 whose registered office is at International House, 12 Constance Street,
                London, E16 2DQ;
              </div>
              <div class="mb-3">
                UK and EU Cookie Law the Privacy and Electronic Communications (EC Directive) Regulations 2003 as
                amended by the Privacy and Electronic Communications (EC Directive) (Amendment) Regulations 2011;
              </div>
              <div class="mb-3">
                User or you any third party that accesses the Website and is not either (i) employed by Family Tree 365
                Ltd and acting in the course of their employment or (ii) engaged as a consultant or otherwise providing
                services to Family Tree 365 Ltd and accessing the Website in connection with the provision of such
                services; and
              </div>
              <div class="mb-3">
                Website the website that you are currently using, www.familytree365.com, and any sub-domains of this
                site unless expressly excluded by their own terms and conditions.
              </div>
              <div class="mb-3">In this privacy policy, unless the context requires a different interpretation:</div>
              <div class="mb-3">the singular includes the plural and vice versa;</div>
              <div class="mb-3">
              ...
              <div class="mb-3">"including" is understood to mean "including without limitation";</div>
              <div class="mb-3">reference to any statutory provision includes any modification or amendment of it;</div>
              <div class="mb-3">the headings and sub-headings do not form part of this privacy policy.</div>
              <div class="is-size-6 has-text-black has-text-weight-medium my-5">Scope of this privacy policy</div>
              <div class="mb-3">
                This privacy policy applies only to the actions of Family Tree 365 Ltd and Users with respect to this
              ...
              <div class="mb-3">
                For purposes of the applicable Data Protection Laws, Family Tree 365 Ltd is the "data controller". This
                means that Family Tree 365 Ltd determines the purposes for which, and the manner in which, your Data is
                processed.
              </div>
              <div class="is-size-6 has-text-black has-text-weight-medium my-5">Data collected</div>
              <div>We may collect the following Data, which includes personal Data, from you:</div>
              <div class="is-size-6 has-text-black has-text-weight-medium my-5">name;</div>
              <div class="mb-3">contact Information such as email addresses and telephone numbers;</div>
              <div class="mb-3">financial information such as credit / debit card numbers;</div>
              <div class="is-size-6 has-text-black has-text-weight-medium my-5">
                IP address (automatically collected);
              </div>
              <div class="mb-3">web browser type and version (automatically collected);</div>
              <div class="mb-3">operating system (automatically collected);</div>
              <div class="mb-3">in each case, in accordance with this privacy policy.</div>
              <div class="is-size-6 has-text-black has-text-weight-medium my-5">How we collect Data</div>
              <div class="is-size-6 has-text-black has-text-weight-medium my-5">
                We collect Data in the following ways:
              </div>
              <div class="mb-3">data is given to us by you ; and</div>
              <div class="mb-3">data is collected automatically.</div>
              <div class="mb-3">Data that is given to us by you</div>
              <div class="mb-3">Family Tree 365 Ltd will collect your Data in a number of ways, for example:</div>
              <div class="mb-3">
                when you contact us through the Website, by telephone, post, e-mail or through any other means;
              </div>
              <div class="mb-3">when you register with us and set up an account to receive our products/services;</div>
              <div class="mb-3">when you make payments to us, through this Website or otherwise;</div>
              <div class="mb-3">when you use our services;</div>
              <div class="mb-3">in each case, in accordance with this privacy policy.</div>
              <div class="mb-3">Data that is collected automatically</div>
              <div class="mb-3">
                To the extent that you access the Website, we will collect your Data automatically, for example:
              </div>
              <div class="mb-3">
                we automatically collect some information about your visit to the Website. This information helps us to
              ...
              <div class="is-size-6 has-text-black has-text-weight-medium my-5">Our use of Data</div>
              <div>
              ...
              <div class="mb-3">internal record keeping;</div>
              <div class="mb-3">improvement of our products / services;</div>
              <div class="mb-3">in each case, in accordance with this privacy policy.</div>
              <div class="mb-3">
              ...
              <div class="is-size-6 has-text-black has-text-weight-medium my-5">Who we share Data with</div>
              <div class="mb-3">
                We may share your Data with the following groups of people for the following reasons:
              </div>
              <div class="mb-3">
                third party payment providers who process payments made over the Website - to enable third party payment
                providers to process user payments and refunds;
              </div>
              <div class="mb-3">in each case, in accordance with this privacy policy.</div>
              <div class="is-size-6 has-text-black has-text-weight-medium my-5">Keeping Data secure</div>
              <div class="mb-3">
              ...
              <div class="mb-3">we store your Data on secure servers.</div>
              <div class="mb-3">
                payment details are encrypted using SSL technology (typically you will see a lock icon or green address
              ...
              <div class="mb-3">
                ...
                contacting us via this e-mail address: support@familytree365.com.
              </div>
              <div class="mb-3">
              ...
              <div class="is-size-6 has-text-black has-text-weight-medium my-5">Data retention</div>
              <div class="mb-3">
              ...
              <div class="is-size-6 has-text-black has-text-weight-medium my-5">Your rights</div>
              <div class="mb-3">You have the following rights in relation to your Data:</div>
              <div class="mb-3">
              ...
              <div class="mb-3">
                Right to restrict our use of your Data - the right to "block" us from using your Data or limit the way
              ...
              <div class="mb-3">
                ...
                of your Data (where consent is our legal basis for processing your Data), please contact us via this
                e-mail address: support@familytree365.com.
              </div>
              <div class="mb-3">
                If you are not satisfied with the way a complaint you make in relation to your Data is handled by us,
                you may be able to refer your complaint to the relevant data protection authority. For the UK, this is
                the Information Commissioner's Office (ICO). The ICO's contact details can be found on their website at
                https://ico.org.uk/.
              </div>
              <div class="mb-3">
              ...
              <div class="is-size-6 has-text-black has-text-weight-medium my-5">Links to other websites</div>
              <div>
              ...
              <div>
                Family Tree 365 Ltd may, from time to time, expand or reduce our business and this may involve the sale
                and/or the transfer of control of all or part of Family Tree 365 Ltd. Data provided by Users will, where
                it is relevant to any part of our business so transferred, be transferred along with that part and the
                new owner or newly controlling party will, under the terms of this privacy policy, be permitted to use
                the Data for the purposes for which it was originally supplied to us.
              </div>
              <div>We may also disclose Data to a prospective purchaser of our business or any part of it.</div>
              <div>In the above instances, we will take steps with the aim of ensuring your privacy is protected.</div>
              <div class="is-size-6 has-text-black has-text-weight-medium my-5">Cookies</div>
              <div class="mb-3">
                This Website may place and access certain Cookies on your computer. Family Tree 365 Ltd uses Cookies to
                improve your experience of using the Website and to improve our range of services. Family Tree 365 Ltd
              ...
              <div class="mb-3">
                ...
                Family Tree 365 Ltd to provide a better experience and service to you. You may, if you wish, deny
              ...
              <div class="is-size-6 has-text-black has-text-weight-medium my-5">Type of Cookie Purpose</div>
              <div class="mb-3">
              ...
              <div class="mb-3">You can find a list of Cookies that we use in the Cookies Schedule.</div>
              <div class="mb-3">
              ...
              <div class="is-size-6 has-text-black has-text-weight-medium my-5">General</div>
              <div class="mb-3">
              ...
              <div class="is-size-6 has-text-black has-text-weight-medium my-5">Changes to this privacy policy</div>
              <div>
                Family Tree 365 Ltd reserves the right to change this privacy policy as we may deem necessary from time
                to time or as may be required by law. Any changes will be immediately posted on the Website and you are
                deemed to have accepted the terms of the privacy policy on your first use of the Website following the
                alterations. You may contact Family Tree 365 Ltd by email at
                <a href="mailto:support@familytree365.com" class="has-text-link">support@familytree365.com.</a>
              </div>
              <div class="is-size-6 has-text-black has-text-weight-medium my-5">Cookies</div>
              <div>
              ...
              <div class="is-size-6 has-text-black has-text-weight-medium my-5">Strictly necessary</div>
              <div>We use the following strictly necessary cookies:</div>
              <div class="is-size-6 has-text-black has-text-weight-medium my-5">Description of Cookie Purpose</div>
              <div>
                Session cookie We use this session cookie to remember you and maintain your session whilst you are using
                our website.
              </div>
            </div>
          </div>

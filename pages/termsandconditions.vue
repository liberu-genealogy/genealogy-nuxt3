            ...
            <div class="column">
              <nav class="breadcrumb mb-2" aria-label="breadcrumbs">
                <ul class="ml-0 d-flex">
                  ...
                  <li class="is-active">
                    <a aria-current="page">Terms &amp; Conditions</a>
                  </li>
                </ul>
              </nav>
              <h1 class="is-size-4 has-text-black has-text-weight-bold mb-5 mt-0">Terms and Conditions of Use</h1>
              <div class="is-size-6 has-text-black has-text-weight-medium my-5">Introduction</div>
              <div class="mb-3">
                These terms and conditions apply between you, the User of this Website (including any sub-domains,
                unless expressly excluded by their own terms and conditions), and Family Tree 365 Ltd, the owner and
                operator of this Website. Please read these terms and conditions carefully, as they affect your legal
              ...
              <div class="mb-3">
                In these terms and conditions, User or Users means any third party that accesses the Website and is not
                either (i) employed by Family Tree 365 Ltd and acting in the course of their employment or (ii) engaged
                as a consultant or otherwise providing services to Family Tree 365 Ltd and accessing the Website in
              ...
              <div class="mb-3">
                ...
                terms and conditions, you represent and warrant that you are at least 18 years of age.
              </div>
              <div class="is-size-6 has-text-black has-text-weight-medium my-5">
                Intellectual property and acceptable use
              </div>
              <div class="mb-3">
                All Content included on the Website, unless uploaded by Users, is the property of Family Tree 365 Ltd,
                our affiliates or other relevant third parties. In these terms and conditions, Content means any text,
              ...
              <div class="mb-3">You may, for your own personal, non-commercial use only, do the following:</div>
              <div class="mb-3">retrieve, display and view the Content on a computer screen</div>
              <div class="mb-3">
                You must not otherwise reproduce, modify, copy, distribute or use for commercial purposes any Content
                without the written permission of Family Tree 365 Ltd.
              </div>
              <div class="mb-3">
                ...
                upload to, distribute or otherwise publish through the Website any Content that (i) is confidential,
                proprietary, false, fraudulent, libellous, defamatory, obscene, threatening, invasive of privacy or
                publicity rights, infringing on intellectual property rights, abusive, illegal or otherwise
                objectionable; (ii) may constitute or encourage a criminal offence, violate the rights of any party or
                otherwise give rise to liability or violate any law; or (iii) may contain software viruses, political
                campaigning, chain letters, mass mailings, or any form of "spam." You may not use a false email address
                or other identifying information, impersonate any person or entity or otherwise mislead as to the origin
                of any content. You may not upload commercial content onto the Website.
              </div>
              <div>
                You represent and warrant that you own or otherwise control all the rights to the Content you post; that
                the Content is accurate; that use of the Content you supply does not violate any provision of these
                terms and conditions and will not cause injury to any person; and that you will indemnify Family Tree
                365 Ltd for all claims resulting from Content you supply.
              </div>
              <div class="is-size-6 has-text-black has-text-weight-medium my-5">Prohibited use</div>
              <div class="mb-3">You may not use the Website for any of the following purposes:</div>
              <div class="mb-3">
              ...
              <div class="is-size-6 has-text-black has-text-weight-medium my-5">Registration</div>
              <div class="mb-3">
              ...
              <div class="is-size-6 has-text-black has-text-weight-medium my-5">Password and security</div>
              <div class="mb-3">
                When you register on this Website, you will be asked to create a password, which you should keep
              ...
              <div class="is-size-6 has-text-black has-text-weight-medium my-5">Privacy Policy and Cookies Policy</div>
              <div class="mb-3">
                ...
                click on the following: www.familytree365.com/privacy and www.familytree365.com/cookies.
              </div>
              <div class="is-size-6 has-text-black has-text-weight-medium my-5">
                Availability of the Website and disclaimers
              </div>
              <div class="mb-3">
                Any online facilities, tools, services or information that Family Tree 365 Ltd makes available through
                the Website (the Service) is provided "as is" and on an "as available" basis. We give no warranty that
                the Service will be free of defects and/or faults. To the maximum extent permitted by the law, we
                provide no warranties (express or implied) of fitness for a particular purpose, accuracy of information,
                compatibility and satisfactory quality. Family Tree 365 Ltd is under no obligation to update information
                on the Website.
              </div>
              <div class="mb-3">
                Whilst Family Tree 365 Ltd uses reasonable endeavours to ensure that the Website is secure and free of
                errors, viruses and other malware, we give no warranty or guaranty in that regard and all Users take
                responsibility for their own security, that of their personal details and their computers.
              </div>
              <div class="mb-3">
                Family Tree 365 Ltd accepts no liability for any disruption or non-availability of the Website.
              </div>
              <div class="mb-3">
                Family Tree 365 Ltd reserves the right to alter, suspend or discontinue any part (or the whole of) the
                Website including, but not limited to, any products and/or services available. These terms and
                conditions shall continue to apply to any modified version of the Website unless it is expressly stated
                otherwise.
              </div>
              <div class="is-size-6 has-text-black has-text-weight-medium my-5">Limitation of liability</div>
              <div class="mb-3">
              ...
              <div class="mb-3">
                To the extent that the Website and Content are provided free of charge, we will not be liable to you for
              ...
              <div class="mb-3">
                To the maximum extent permitted by law, Family Tree 365 Ltd accepts no liability for any of the
                following:
              </div>
              <div class="mb-3">
              ...
              <div class="mb-3">loss or corruption of any data, database or software;</div>
              ...
              <div class="mb-3">Family Tree 365 Ltd details</div>
              <div class="mb-3">
                Family Tree 365 Ltd is a company incorporated in England and Wales with registered number 13641244 whose
                registered address is Kemp House, 160 City Road, London, United Kingdom, EC1V 2NX and it operates the
                Website www.familytree365.com.
              </div>
              <div>
                You can contact Family Tree 365 Ltd by email on
